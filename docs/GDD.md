...
| Test infrastructure            | 156 registered headless scenarios; prior complete-suite evidence is 148 pass / 1 expected skip over 149, plus 2/2 targeted inventory live scenarios, account-discovery isolation, and party-message carrier checks on 2026-09-24; skill-expectation generator, observer-parity harness, `playtest-sprite-audit`, full workspace tests pass (latest Korangar library 405 passed, 17 ignored). |
