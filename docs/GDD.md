...
| Test infrastructure            | 160 registered headless scenarios; prior complete-suite evidence is 148 pass / 1 expected skip over 149, plus targeted inventory live scenarios, account-discovery isolation, party-message carrier, party-quest-credit, reviewed Brasilis quest-NPC interaction, and bidirectional navigation portal traversal. Latest targeted continuation passes include the full Izlude-to-dungeon route and the party-quest-credit → account-discovery-isolation sequence, with fixture cleanup clean. Skill-expectation generator, observer-parity harness, `playtest-sprite-audit`, and `cargo test --workspace` pass (Korangar library: 411 passed, 17 ignored). |
