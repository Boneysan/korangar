...
*Status refresh: 2026-09-24. Code-backed summaries below include the Guide's All-category search, tracked quest references/routes, quest-marker visibility, and the remappable party Danger ping. Live server, mixed-client, and visual acceptance remain marked open; visual checks are intentionally deferred.*
