...
| Test infrastructure            | 151 registered headless scenarios; prior complete-suite evidence is 148 pass / 1 expected skip over 149, plus targeted inventory live scenarios on 2026-09-24 (latest split/storage rerun 2/2); skill-expectation generator, observer-parity harness, `playtest-sprite-audit`, full workspace tests pass (Korangar library 405 passed, 17 ignored). |
