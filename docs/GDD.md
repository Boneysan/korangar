...
| Test infrastructure            | 152 registered headless scenarios; prior complete-suite evidence is 148 pass / 1 expected skip over 149, plus 2/2 latest targeted inventory live scenarios and 1/1 party-ping carrier scenario on 2026-09-24; skill-expectation generator, observer-parity harness, `playtest-sprite-audit`, full workspace tests pass (Korangar library 405 passed, 17 ignored). |
