...
| **§** | **Design item**                | **Hook that exists**                                                                                                                                  | **Gap**                                                                                                                                                                                    | **Size** |
|-------|--------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|
| 9.2   | World map                      | Generated static-warp graph and in-game atlas/route finder; selected destination details show visit-sync state, known outgoing portal exits, route hop count, and the next verified portal's exact map cell/destination. Current-map walkable breadcrumb routing and Guide/atlas visited badges are present. The headless live test traversed Prontera ↔ `prt_fild08` in both directions through walk-triggered warps on PACKETVER 20220406; fixture cleanup audit passed. | Add authored display/service details and broader dynamic/conditional travel coverage; validate Izlude's dungeon route, client route following, and visual acceptance. No teleport. | M-L |
...
| Test infrastructure            | 158 registered headless scenarios; prior complete-suite evidence is 148 pass / 1 expected skip over 149, plus 2/2 targeted inventory live scenarios, account-discovery isolation, party-message carrier, party-quest-credit, and bidirectional navigation portal traversal checks on 2026-09-24; the latest navigation run passed and fixture cleanup was clean. Skill-expectation generator, observer-parity harness, `playtest-sprite-audit`, full workspace tests pass (latest Korangar library 405 passed, 17 ignored). |
