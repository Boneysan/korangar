...
| **High** *(partial 2026-07-17; E1 code 2026-07-22)* | **Classic skill-effect coverage pass** — audit the rest of the skill catalog for the three wiring gaps the Wizard kit hit (§8 Combat, M1-008) | **Batches 1–2 + Phase E1 code:** prior Knight/Wizard STR + caster-burst work stands. **E1 (2026-07-22):** Napalm Beat, Soul Strike orbs, Frost Diver travel, Fire Ball travel, Jupitel Thunder ball, Earth Spike / Heaven's Drive ground spikes — typed in `skill_recipe.rs`, procedural `SkillBurst` / `SoulStrikeOrbs` / `TravelBall`, GRF audit green. **Still open:** E1 **live GUI** acceptance; E2 persistent skill-unit visuals beyond Firewall/Pneuma; E3 `DisplaySpecialEffectPacket` (0x01F3) + cast circles + sound retry; E4 status presentation depth; catalog-wide classic sounds. See [plans/animation-fidelity.md](plans/animation-fidelity.md) §6. |
