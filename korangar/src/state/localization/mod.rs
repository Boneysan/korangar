...
pub struct Localization {
    ...
    /// Character overview / menu: open or close the minimap.
    minimap_button_text: String,
    /// Game settings checkbox label for minimap visibility.
    show_minimap_button_text: String,
    ...
    dialog_input_ok_text: String,
    dialog_number_input_ghost: String,
    dialog_string_input_ghost: String,
