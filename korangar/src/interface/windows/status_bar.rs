...
/// MVP status effect bar window. Binds to the cached display_text in StatusEffects.
    ...
    P: Path<ClientState, crate::state::status_effects::StatusEffects>,
{
    ...
    fn to_window<'a>(self) -> impl Window<ClientState> + 'a {
        ...
        // Because RustState generates field accessors, we can do .display_text() on the effects path.
