...
pub fn window(token_stream: TokenStream) -> TokenStream {
    create_component_macro!(korangar_interface::window::WindowInternal, {
        ...
        highlight_color: { korangar_interface::theme::theme().window().highlight_color() },
        shadow_color: { korangar_interface::theme::theme().window().shadow_color() },
        shadow_padding: { korangar_interface::theme::theme().window().shadow_padding() },
...
pub fn button(token_stream: TokenStream) -> TokenStream {
    create_component_macro!(korangar_interface::components::button::Button, {
        ...
        highlight_color: { korangar_interface::theme::theme().button().highlight_color() },
        ...
        shadow_color: { korangar_interface::theme::theme().button().shadow_color() },
        shadow_padding: { korangar_interface::theme::theme().button().shadow_padding() },
...
pub fn state_button(token_stream: TokenStream) -> TokenStream {
    create_component_macro!(korangar_interface::components::state_button::StateButton, {
        ...
        highlight_color: { korangar_interface::theme::theme().state_button().highlight_color() },
        ...
        shadow_color: { korangar_interface::theme::theme().state_button().shadow_color() },
        shadow_padding: { korangar_interface::theme::theme().state_button().shadow_padding() },
...
pub fn drop_down(token_stream: TokenStream) -> TokenStream {
    create_component_macro!(korangar_interface::components::drop_down::DropDown, {
        ...
        highlight_color: { korangar_interface::theme::theme().drop_down().button_highlight_color() },
        ...
        shadow_color: { korangar_interface::theme::theme().drop_down().button_shadow_color() },
        shadow_padding: { korangar_interface::theme::theme().drop_down().button_shadow_padding() },
...
pub fn field(token_stream: TokenStream) -> TokenStream {
    create_component_macro!(korangar_interface::components::field::Field, {
        ...
        highlight_color: { korangar_interface::theme::theme().field().highlight_color() },
        shadow_color: { korangar_interface::theme::theme().field().shadow_color() },
        shadow_padding: { korangar_interface::theme::theme().field().shadow_padding() },
...
pub fn text_box(token_stream: TokenStream) -> TokenStream {
    create_component_macro!(korangar_interface::components::text_box::TextBox, {
        ...
        highlight_color: { korangar_interface::theme::theme().text_box().highlight_color() },
        ...
        shadow_color: { korangar_interface::theme::theme().text_box().shadow_color() },
        shadow_padding: { korangar_interface::theme::theme().text_box().shadow_padding() },
